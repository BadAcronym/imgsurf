...
(
    ...
    uint8_t result = imgsurf_write_file("assets/reconstructed.qoi", testQOI,
                                        width, height, IMGSURF_CHANNELS_RGBA, 8,
                                        IMGSURF_FILE_QOI);
    if(result)
    {
        free(testQOI);
    ...
    // result = imgsurf_write_file("assets/reconstructed.png", testPNG, width, height,
    //                             IMGSURF_CHANNELS_RGBA, 8, IMGSURF_FILE_PNG);
    // if(result)
    // {
    //     return result;
    // }

    // uint8_t *reconstructedPNG = imgsurf_load_file("assets/reconstructed.png",
    //                                               &width, &height,
    //                                              IMGSURF_CHANNELS_RGBA, 8);
    ...
    //     {
    //         fprintf(stderr, "\x1b[1;31mimgsurf_write failed @ pixel %lu.red, "
    ...
    //     {
    //         fprintf(stderr, "\x1b[1;31mimgsurf_write failed @ pixel %lu.green, "
    //                 "expected: %u, got: %u\n", i / 4, reconstructedQOI[i],
    //                 reconstructedPNG[i]);
    //         return 3;
    //     }
    //     if(reconstructedQOI[i + 2] != reconstructedPNG[i + 2])
    //     {
    //         fprintf(stderr, "\x1b[1;31mimgsurf_write failed @ pixel %lu.blue, "
    //                 "expected: %u, got: %u\n", i / 4, reconstructedQOI[i],
    //                 reconstructedPNG[i]);
    //         return 4;
    //     }
